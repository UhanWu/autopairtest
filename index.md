...
combinations, with intelligent test selection based on data properties.
...
Compares a continuous outcome across all group pairs. Automatically
selects: - **Welch t-test** if both groups pass Shapiro-Wilk normality
(p \> 0.05) - **Wilcoxon rank-sum** otherwise
...
Compares a categorical outcome across all group pairs. Automatically
selects: - **Chi-square test** if all expected cell counts ≥ 5 -
